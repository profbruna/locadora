            ...
            <div class="row-fluid"> 
                ...
                <div class="span12">
                    <div class="well">
                        ...
                        echo form_open("estadoController/alterar_estado/$codigo");
                        echo form_fieldset('Informações dos Estados');
                        ?>
                        <form class="form-horizontal">
                            <div class="control-group">
                                <?php
                                echo form_label("Nome:");
                                echo form_input('nome', set_value('nome', @$estado->nome), 'size="50" class="campo" required');
                                echo br();
