                ...
                <div class="span12">
                    <div class="well">
                        ...
                        foreach ($generos as $c) {
                            $link_alterar = anchor("generoController/alterar_cidade/$c->codigo", 'Editar', 'title="Editar"');
                            $link_eliminar = anchor("generoController/eliminar_cidade/$c->codigo", 'Excluir', 'title="Excluir"');                   
