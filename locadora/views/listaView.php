...
<html>
    ...
    <body>
        <div id="menu">
            ...
            <ul class="nav nav-tabs nav-stacked"> 
                <li style="margin-left: 970px; margin-top: -130px;"><?php echo anchor("condicao_pagamentoController/index", 'Listar Cond. Pagamento', 'title="Listar Cond. Pagamento"', 'class="novo"'); ?></li>                       
            </ul>
        </div>
    </body>
</html>
