            ...
            <div class="row-fluid"> 
                ...
                <div class="span12">
                    <div class="well">
                        ...
                        echo form_open('produtoController/alterar_produto/' . @$produto->codigo);
                        ...
                        <form class="form-horizontal">
                            <div class="control-group">
                                ...
                                echo form_input('nome', set_value('nome', @$produto->nome), 'size="50" class="campo" required');
                                echo br();

                                echo form_label("Quantidade: ");
                                echo form_input('quantidade', set_value('quantidade', @$produto->quantidade), 'size="5" class="campo"');
                                echo br();

                                echo form_label("Quantidade Locado: ");
                                echo form_input('quantidade_locado', set_value('quantidade_locado', @$produto->quantidade_locado), 'size="5" class="campo" required');
                                echo br();

                                echo form_label("Quantidade Disponivel: ");
                                echo form_input('quantidade_disponivel', set_value('quantidade_disponivel', @$produto->quantidade_disponivel), 'size="10" class="campo" required');
                                echo br();

                                echo form_label("Valor: ");
                                echo form_input('valor', set_value('valor', @$produto->valor), 'size="10" class="campo"');
                                echo br();

                                echo form_label("Inativo: ");
                                echo form_checkbox('inativo', 'S', FALSE, set_value('inativo', @$produto->inativo), 'size="50" class="campo" required');
                                echo br();

                                echo form_label("Data Cadastro: ");
                                echo form_input('data_cadastro', set_value('data_cadastro', @$produto->data_cadastro), 'size="50" class="campo" required id="datepicker"');
                                echo br();

                                echo form_label("Numero Serie: ");
                                echo form_input('numero_serie', set_value('numero_serie', @$produto->numero_serie), 'size="50" class="campo" required');
                                echo br();

                                echo form_label("Detalhes: ");
                                echo form_input('detalhes', set_value('detalhes', @$produto->detalhes), 'size="50" class="campo" required');
                                echo br();
                                ...
                                echo form_dropdown('genero_codigo', $listagem, set_value('genero_codigo', @$produto->genero_codigo), 'required');
                                echo br();
                                ...
                                echo form_dropdown('classificacao_codigo', $listagem, set_value('classificacao_codigo', @$produto->classificacao_codigo), 'required');
                                echo br();
                                ...
                                echo form_dropdown('tipo_codigo', $listagem, set_value('tipo_codigo', @$produto->tipo_codigo), 'required');
                                echo br();

                                echo form_label("Dias Devolução: ");
                                echo form_input('dias_devolucao', set_value('dias_devolucao', @$produto->dias_devolucao), 'size="50" class="campo" required');
                                echo br();
